jQuery(document).ready(function() {
  jQuery.getJSON('/projects/front/data.json').then(function(data) {
    jQuery.each(data, function(index, project) {
      ...
      let card = `
        <div class="card border-0 bg-dark" data-bs-toggle="modal" data-bs-target="#projectsModal${project.id}">
          ...
          <div class="card-body text-white p-4">
            ...
            <a data-bs-toggle="modal" data-bs-target="#projectsModal${project.id}" class="viewproject fw-semibold text-decoration-none" style="color: #f9f9f9">View project</a>
          </div>
        </div>
        <div class="modal fade" id="projectsModal${project.id}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="projectsModalLabel" aria-hidden="true">
      ...
      jQuery('#frontcontent').append(card);
    });
